...
exports.BucketFileRepository = void 0;
const store_backed_repository_1 = require("../store-backed.repository");
class BucketFileRepository extends store_backed_repository_1.StoreBackedRepository {
    constructor(store) {
        super(store);
    }
    ...
    async findByTargetDateRange(startDate, endDate) {
        const allBuckets = await this.findAll();
        return allBuckets.filter((bucket) => !!bucket.targetDate && bucket.targetDate >= startDate && bucket.targetDate <= endDate);
    }
...
exports.BucketFileRepository = BucketFileRepository;
//# sourceMappingURL=bucket.file.repository.js.map